...
const SeatSelectionPage = ({ event, setBookingDetails }) => {
  ...
  // Generate the absolute exact layout matching the original design
  const generateSeats = () => {
    const list = [];
        ...
        <div className="xl:col-span-4 flex flex-col gap-6">
          ...
          <div className="glass-panel p-6 rounded-xl select-none text-[13px] leading-relaxed text-on-surface-variant space-y-4">
            ...
            <ul className="space-y-1 pl-4 list-disc">
              <li>VIP seats (Pink) offer direct side-views of the catwalk models.</li>
              <li>Gold seats (Amber) are elevated secondary tier views.</li>      
              <li>Silver (Blue) wraps around the runway in a massive 3-column U-shape.</li>
              <li>Standard (Lavender) encapsulates the outer layers.</li>
            </ul>
          </div>
        </div>
